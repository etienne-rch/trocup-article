...
type Dimensions struct {
	...
	Width  float64 `json:"width" bson:"width" validate:"required"`
	Height float64 `json:"height" bson:"height" validate:"required"`
	Weight float64 `json:"weight" bson:"weight" validate:"required"`
}
...
type Article struct {
	...
	State           string             `json:"state" bson:"state" validate:"required,oneof=NEW USED OLD"`
	...
	Category        string             `json:"category" bson:"category" validate:"required,oneof=CLOTHING SHOES ACCESSORIES_LUGGAGE WATCHES_JEWELRY BABY_CLOTHING GAMES_TOYS FURNITURE APPLIANCES DECORATION ELECTRONICS BICYCLES BOOKS OTHER"`
	...
	Dimensions      Dimensions         `json:"dimensions" bson:"dimensions" validate:"required"`
